...
(cl:defmethod cl:initialize-instance :after ((m <behavior>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'behavior)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package1-msg:<behavior> is deprecated: use package1-msg:behavior instead.")))

(cl:ensure-generic-function 'active-val :lambda-list '(m))
(cl:defmethod active-val ((m <behavior>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package1-msg:active-val is deprecated.  Use package1-msg:active instead.")
  (active m))

(cl:ensure-generic-function 'vel_fw-val :lambda-list '(m))
(cl:defmethod vel_fw-val ((m <behavior>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package1-msg:vel_fw-val is deprecated.  Use package1-msg:vel_fw instead.")
  (vel_fw m))

(cl:ensure-generic-function 'vel_turn-val :lambda-list '(m))
(cl:defmethod vel_turn-val ((m <behavior>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package1-msg:vel_turn-val is deprecated.  Use package1-msg:vel_turn instead.")
  (vel_turn m))
